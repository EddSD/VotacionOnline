    ...
    <div class="container" style="padding:100px;">
      <div class="row">
        <?php
          ...
          if(isset($_POST["import"])){
            ...
            if($_FILES["file"]["size"] > 0){
              ...
              while(($column = fgetcsv($file, 10000, ",")) !== FALSE){
                $sqlInsert = "insert into candidatos (nombre, carrera, cuatri, num_votos) values('" . $column[0] . "', '" . $column[1] . "', '" . $column[2] . "', '" . $column[3] . "')";
          ...
          if (isset($_POST["cleanVotos"])) {
            mysqli_query($conn, "TRUNCATE TABLE votos");
          }
       ...
       <form class="form-horizoontal" method="post" action="" name="BorrarCsv" enctype="multipart/form-data">
        ...
        <div>
          <button type="submit" class="btn btn-success navbar-left navbar-btn" name="cleanVotos">Vaciar Votos</button>
        </div>
        </form>
