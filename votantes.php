          ...
          if(isset($_POST["import"])){
            ...
            if($_FILES["file"]["size"] > 0){
              ...
              while(($column = fgetcsv($file, 10000, ",")) !== FALSE){
                $sqlInsert = "insert into votantes (nombre, carcuat, usuario, contraseña, id_votante) values('" . $column[0] . "', '" . $column[1] . "', '" . $column[2] . "', '" . $column[3] . "','" . $column[4] . "')";
      ...
      <div class="col-sm-12">
        <table class="table table-bordered table-hover">
          <tr>
            ...
            <th><strong>Carrera, Grupo y Cuatri</strong></th>
            <th><strong>Usuario</strong></th>
            <th><strong>ID de Votante (Matricula)</strong></th>
          </tr>
